...
const HeaderLink: React.FC<HeaderLinkProps> = ({text, Icon, avatar, feed, active, hidden}) => {
  ...
  return (
    <div
      className={`
        ...
        cursor-pointer flex flex-col justify-center items-center transition duration-150 linear
        ${feed
